<section class="bg-white">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-0 xl:gap-12 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto lg:col-span-6">
            ...
            <h1 class="max-w-2xl my-4 pl-2 text-5xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">Get Paying Clients in Just 24 Hours with ₦8000 Ad</h1>
        ...
        <div class="mt-5 sm:mt-0 lg:col-span-5 border rounded-md border-gray-100 shadow-lg">
            <p class="mt-1.5"><span class="text-base p-2 rounded-b-xl font-semibold bg-black text-deepr_green-50">Today's Price</span></p>
                            ...
                            <div class="lg:items-start lg:gap-12">
                                <div class="mb-6 grid grid-cols-2 gap-4">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input type="email" id="email" wire:model="billing_email" class="block w-full border rounded border-gray-300 bg-white py-4 px-5 pe-10 text-md text-gray-900 focus:border-green-500 focus:ring-green-500" placeholder="Email Address"/>
                                        <div>
