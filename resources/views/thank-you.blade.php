...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>The Fast Funnel by AJ Thompson</title>
    ...
    <body class="antialiased font-sans">
        <main class="relative h-screen flex flex-1 flex-col overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
            <div class="relative flex flex-1 flex-col items-center justify-center pb-16 pt-12">
                <h1 class="text-2xl font-bold bg-deepr_green-50">The Fast Funnel</h1>
              
                @if ($response['status'])
                    <div class="max-w-2xl text-center">
                        <h1 class="text-3xl font-extrabold text-black sm:text-4xl">Thank you!</h1>
                        <div class="mt-6 text-base leading-7 text-slate-600">Click to the link below to <strong class="font-semibold text-black">download your Fast Funnel Guide.</strong> Also, I've sent you an email with the download link.
                        ...
                        <a class="inline-flex justify-center rounded-lg text-sm font-semibold py-2.5 px-4 bg-black text-white hover:bg-gray-900 mt-6" href="{{ route('download') }}">
